...
async def dashboard(request: Request, username: str = Depends(verify_credentials)):
    return templates.TemplateResponse("index.html", {"request": request, "channels": manager.get_all_channels()})
...
async def play_channel(request: Request, channel_id: str):
    ...
    return templates.TemplateResponse("player.html", {"request": request, "channel": channel})
